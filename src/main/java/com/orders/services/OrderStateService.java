...
public class OrderStateService {
    ...
    private static final String FULL_FILL = "fullFill";
    ...
    public void updateState(UpdateStateOrderApi updateStateOrderApi) {
        ...
        switch (orderState) {
            ...
            case CANCEL:
                ...
                break;
            default:
                throw new StateNotFoundException("Incorrect state order, allowed orderState is: fullFill,pay or cancel, sended order state: " + orderState);
        }
    }
